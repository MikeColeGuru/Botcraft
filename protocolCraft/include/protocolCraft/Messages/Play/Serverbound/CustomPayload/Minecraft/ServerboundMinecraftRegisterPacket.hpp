...
{
    class ServerboundMinecraftRegisterPacket : public BaseMessage<ServerboundMinecraftRegisterPacket>
    {
    public:
        static constexpr int packet_id = ProtocolCraft::ServerboundCustomPayloadPacket::packet_id;
        ...
        virtual ~ServerboundMinecraftRegisterPacket() override
        {
